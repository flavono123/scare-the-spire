...
import BasePage, { generateMetadata as generateBaseMetadata } from "../../_codex/powers/page";
...
export default function CompendiumPowersPage({ searchParams }: { searchParams: RouteSearchParams }) {
  return BasePage({
    searchParams: defaultRouteSearchParams(searchParams),
  });
}
