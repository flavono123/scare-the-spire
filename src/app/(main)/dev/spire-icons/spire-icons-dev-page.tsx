      ...
      <button
        ...
        className={`flex h-7 min-w-9 items-center justify-center rounded border px-1.5 text-[10px] font-semibold transition ${
          value === "original"
            ...
            : "border-border bg-black/20 text-zinc-500 hover:border-white/30"
        }`}
...
function TokenWorkbench() {
  ...
  return (
    <section className="mt-10 overflow-hidden rounded-2xl border border-primary/20 bg-zinc-950/65">
      ...
      <div className="grid gap-6 p-4 sm:p-6 lg:grid-cols-[minmax(250px,0.8fr)_minmax(320px,1.2fr)]">
        <div className="space-y-5">
          <label className="block">
            ...
            <select
              className="w-full rounded-lg border border-white/10 bg-black/40 px-3 py-2.5 text-sm text-zinc-200 outline-none transition focus:border-primary/50"
...
export default function SpireIconsDevPage() {
  return (
    <main className="mx-auto max-w-7xl px-3 py-6 sm:px-5 lg:px-8">
      ...
      <div className="mb-5 flex items-center gap-2 rounded-lg border border-primary/25 bg-primary/5 px-3 py-2">
        <span className="rounded bg-primary/15 px-2 py-0.5 text-[10px] font-black tracking-[0.12em] text-primary">
          DEV ONLY
        </span>
      ...
      <header className="grid gap-5 rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(239,200,81,0.13),transparent_42%),rgba(9,9,11,0.72)] p-5 sm:grid-cols-[auto_1fr] sm:items-center sm:p-7">
        <span className="flex h-20 w-20 items-center justify-center rounded-2xl border border-primary/20 bg-black/30 shadow-[inset_0_0_24px_rgba(239,200,81,0.08)]">
