...
export function CharacterDetail({
  ...
  const formAttachment = selectedForm
    ? (selectedForm.placements as Record<string, MonsterStageFormAttachment>)[character.id] ?? null
    : null;
    ...
    <div className="mx-auto w-full max-w-6xl p-4 sm:p-6">
      ...
      <div className="grid min-w-0 gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,22rem)] lg:items-start">
        ...
        <aside className="flex min-w-0 flex-col gap-3">
          {hasCharacterInfo && (
            <section className="min-w-0 rounded-lg border border-border bg-compendium-rail px-4 py-3">
