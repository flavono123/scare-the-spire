...
const PATCH_COPY: Record<ServiceLocale, {
  ...
  ko: {
    ...
    watchingBody: "아직 공식 패치가 공개되지 않았습니다. 패치가 나오면 먼저 작업 도구 상태로 전환하고, 이후 rich 패치노트를 게시합니다.",
    buildingBadge: "작업 도구",
  ...
  en: {
    ...
    watchingBody: "The official patch is not live yet. Once it appears, this page will move to Tools of the Trade first, then publish the enriched notes.",
    buildingBadge: "Tools of the Trade",
