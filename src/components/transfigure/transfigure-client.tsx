        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-3">
            <Image
              ...
              width={52}
              height={52}
              className="object-contain drop-shadow-[0_0_16px_rgba(103,232,249,0.28)]"
            />
            <h1 className="truncate font-service text-xl font-bold text-cyan-200">
              {title}
            </h1>
          </div>
          {ready && !unavailable && (
            <button
              ...
              className="group/create inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-cyan-300/30 bg-cyan-500/10 px-3 py-2 text-xs font-semibold text-cyan-100 shadow-[0_0_18px_rgba(34,211,238,0.06)] transition-[transform,border-color,background-color,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-cyan-200/50 hover:bg-cyan-500/15 hover:shadow-[0_6px_22px_rgba(34,211,238,0.1)] focus-visible:outline focus-visible:outline-1 focus-visible:outline-cyan-300/70 active:translate-y-0 motion-reduce:transform-none"
            >
              <Sparkles
