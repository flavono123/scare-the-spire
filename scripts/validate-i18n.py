...
KNOWN_UPSTREAM_MISSING_CODEX_TITLE_KEYS = {
    "deu": {
        "cards:SOULBOUND.title",
    },
    "esp": {
        "cards:CACOPHONY.title",
        "cards:CONSTELLATION.title",
        "cards:SOULBOUND.title",
        "cards:WITHER.title",
    ...
    "fra": {
        ...
        "cards:DOWSING.title",
        "cards:FADE.title",
        "cards:HIBERNATE.title",
        "cards:IMITATION_LEARNING.title",
        "cards:MIDNIGHT.title",
        "cards:ONE_FOR_ALL.title",
        "cards:OUTRAGE.title",
        "cards:PLOT.title",
        "cards:SOULBOUND.title",
        "cards:SIDESTEP.title",
        "cards:THE_BALL.title",
        "cards:TUTOR.title",
        "cards:UNDERWORLD.title",
        "monsters:AEONGLASS.name",
        "encounters:AEONGLASS_BOSS.title",
        "potions:AMBERGRIS.title",
        "relics:DOWSING_ROD.title",
        "relics:NEOWS_SACRIFICE.title",
    },
    "ita": {
        "cards:BLADE_SYMPHONY.title",
        "cards:BLAZE.title",
    ...
    "tur": {
        ...
        "cards:UNDERWORLD.title",
        "cards:WITHER.title",
        "encounters:BATTLEWORN_DUMMY_EVENT_V1_ENCOUNTER.title",
        "encounters:BATTLEWORN_DUMMY_EVENT_V2_ENCOUNTER.title",
        "encounters:BATTLEWORN_DUMMY_EVENT_V3_ENCOUNTER.title",
        "monsters:AEONGLASS.name",
        "encounters:AEONGLASS_BOSS.title",
        "relics:SILKEN_TRESS.title",
    },
