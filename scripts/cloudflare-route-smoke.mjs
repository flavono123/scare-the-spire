...
function mainCases() {
  return [
    ...
    ...page("/compendium/sts1/cards", "compendium"),
    ...page("/compendium/sts1/cards/bash", "compendium"),
    ...page("/en/compendium/sts1/cards/bash", "compendium"),
    ...page("/zh/compendium/sts1/cards", "compendium"),
    ...page("/compendium/sts2/cards", "compendium"),
    ...page("/cards", "legacy"),
    ...page("/cards/bash", "legacy"),
    ...page("/cards/strike-ironclad", "legacy"),
    ...
    ...page("/defragment", "service", "data-defragment-page=\"index\""),
    ...page("/history-course", "service"),
    ...page("/this-or-that", "service"),
    ...page("/transfigure", "service"),
    ...page("/pagestorm", "service", "data-pagestorm-page=\"index\""),
    ...page("/pagestorm/write", "service", "data-pagestorm-page=\"write\""),
    ...page("/c-c-c-combo", "service", "data-combo-page=\"index\""),
    ...page("/en/c-c-c-combo", "service"),
    ...page("/zh/c-c-c-combo", "service"),
    ...page("/en/contact", "service"),
    ...page("/zh/contact", "service"),
    ...page("/en/defragment", "service"),
    ...page("/zh/defragment", "service"),
    ...page("/en/transfigure", "service"),
    ...page("/zh/transfigure", "service"),
    ...page("/en/pagestorm", "service"),
    ...page("/zh/pagestorm", "service"),
    ...page("/en/pagestorm/write", "service"),
    ...page("/zh/pagestorm/write", "service"),
    ...page(`/chemical-x/${MISSING_UUID}`, "shell"),
    ...page(`/c-c-c-combo/${MISSING_UUID}`, "shell"),
    ...page(`/defragment/${MISSING_UUID}`, "shell"),
    ...page(`/defragment/combo/${MISSING_UUID}`, "shell"),
    ...page(`/defragment/transfigure/${MISSING_UUID}`, "shell"),
    ...page(`/defragment/pagestorm/${MISSING_UUID}`, "shell"),
    ...page(`/this-or-that/${MISSING_UUID}`, "shell"),
    ...
    ...missingPage(`/defragment/${MISSING_UUID}/extra`),
    ...missingPage(`/defragment/combo/${MISSING_UUID}/extra`),
    ...missingPage(`/defragment/pagestorm/${MISSING_UUID}/extra`),
    ...missingPage(`/this-or-that/${MISSING_UUID}/extra`),
    ...missingPage(`/this-or-that/tournament/${MISSING_UUID}/extra`),
    ...missingPage(`/this-or-that/worldcup/${MISSING_UUID}/extra`),
    {
      name: `/this-or-that/worldcup/${MISSING_UUID} document`,
      path: `/this-or-that/worldcup/${MISSING_UUID}`,
      headers: { Accept: "text/html" },
      statuses: [308],
      location: `/this-or-that/tournament/${MISSING_UUID}`,
    },
    {
      name: `/this-or-that/worldcup/${MISSING_UUID} RSC`,
      path: `/this-or-that/worldcup/${MISSING_UUID}?_rsc=smoke`,
      headers: { RSC: "1" },
      statuses: [308],
      location: `/this-or-that/tournament/${MISSING_UUID}`,
    },
    {
      name: `/en/this-or-that/worldcup/${MISSING_UUID} document`,
      path: `/en/this-or-that/worldcup/${MISSING_UUID}`,
      headers: { Accept: "text/html" },
      statuses: [308],
