...
import { STS1_ATLAS_LAYER_STYLE, STS1_CARD_IN_ATLAS } from "../src/lib/sts1/card-style";
...
assert.equal(sts1CardUi512Url("card_shadow"), `/images/sts1/card-ui-512/card_shadow.webp?v=${STS1_IMAGE_CACHE_BUSTER}`);
assert.equal(
